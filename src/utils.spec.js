...
describe('Utils tests', () => {
    describe('Testing the usages-sorter function', () => {
        it('Should sort correctly', () => {
            ...
            for (let i = 0; i < usagesArray.length; i++) {
                expect(usagesArray[i].usages).toBeLessThanOrEqual(highest.usages)
            }
        })
    })
    ...
    describe('Testing transformed entries', () => {
        it('Is transformed in a proper way', () => {
            ...
            expect(result).toEqual({ name: expected.name, desc: expected.desc, path: expected.path, usages: expected.usages })
        })
    })
